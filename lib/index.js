  ...
  _createClass(Animated, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var _props = this.props,
          ...
          animationInDuration = _props.animationInDuration,
          animationOutDuration = _props.animationOutDuration;

      if (isVisible !== nextProps.isVisible || animationIn !== nextProps.animationIn || animationOut !== nextProps.animationOut || animationInDelay !== nextProps.animationInDelay || animationOutDelay !== nextProps.animationOutDelay || animationInDuration !== nextProps.animationInDuration || animationOutDuration !== nextProps.animationOutDuration) {
